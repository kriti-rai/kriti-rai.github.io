...
I was recently working on a [lab](https://github.com/learn-co-students/crud-lab-v-000) in building a [Yelp](https://www.yelp.com/)-like application that uses [React](https://reactjs.org/) and [Redux](https://redux.js.org/) to add and delete restaurants and  their reviews. 
